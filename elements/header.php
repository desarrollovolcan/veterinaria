<?php
$authUser = $authUser ?? (class_exists('Auth') ? Auth::user() : ['nombre' => 'Usuario', 'rol' => 'Sin rol']);
?>
<div class="header">
	<div class="header-content">
			...
			<div class="collapse navbar-collapse justify-content-between">
				...
				<ul class="navbar-nav header-right main-notification">
					...
					<li class="nav-item dropdown notification_dropdown d-sm-flex d-none">
						...
						<div class="dropdown-menu dropdown-menu-end">
							<div id="DZ_W_TimeLine11" class="widget-timeline dz-scroll p-3 style-1 height370">
								<ul class="timeline">
									<li>
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
							...
							<div class="header-info">
								<span><?php echo htmlspecialchars((string) ($authUser['nombre'] ?? 'Invitado'), ENT_QUOTES, 'UTF-8'); ?></span>
								<small><?php echo htmlspecialchars((string) ($authUser['rol'] ?? 'Sin rol'), ENT_QUOTES, 'UTF-8'); ?></small>
							</div>
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							...
							<a href="index.php?controller=module&action=index&module=users" class="dropdown-item ai-icon">
								<svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
									<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
									<polyline points="22,6 12,13 2,6"></polyline>
								</svg>
								<span class="ms-2">Gestión usuarios </span>
							</a>
							<a href="index.php?action=logout" class="dropdown-item ai-icon">
		...
		<div class="sub-header">
			<div class="d-flex align-items-center flex-wrap me-auto">
				<h5 class="dashboard_bar"><?php echo $pageTitle; ?></h5>
			</div>
